...
import com.yandihard.tvmoviesapp.submission.fragment.FavoriteMoviesFragment
import com.yandihard.tvmoviesapp.submission.fragment.FavoriteTvFragment
import com.yandihard.tvmoviesapp.submission.fragment.TvshowFragment

class SectionsPagerAdapter2nd(private val mContext: Context, fm: FragmentManager) : FragmentPagerAdapter(fm, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
    @StringRes
